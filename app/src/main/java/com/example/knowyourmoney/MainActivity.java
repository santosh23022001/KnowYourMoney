...
code = r'''package com.example.knowyourmoney;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentSummaryText = findViewById(R.id.paymentSummaryText);
    ...
    private void updateDashboard() {
        ...
        for (Transaction transaction : transactions) {
            ...
            if ("Cash".equals(transaction.paymentMode)) {

                cashTotal += transaction.amount;

            } else if ("UPI".equals(transaction.paymentMode)) {

                upiTotal += transaction.amount;

            } else if ("Card".equals(transaction.paymentMode)) {

                cardTotal += transaction.amount;

            } else if ("Bank Transfer".equals(transaction.paymentMode)) {
